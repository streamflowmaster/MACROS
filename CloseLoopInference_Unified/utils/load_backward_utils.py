...
from load_backward_model import load_CNMRSpectraGPT,load_HNMRSpectraGPT,load_HSQCSpectraGPT
...
#     gpt_config = HNMRSpectraConfig(n_layer=n_layer, n_head=n_head, n_embd=n_embd,
#                             dropout=dropout, bias=bias,
#                             prompt_pe=prompt_pe,block_size=block_size,
...
#                       start_generate_token = start_generate_token,
#                       prompt_pe = prompt_pe)  # start with model_args from command line
#
...
#         # # create the model
#         # gptconf = HNMRSpectraConfig(**model_args)
#         # model = HNMRSpectraGPT(gptconf)
...
#     # -----------------------------------------------------------------------------
#     # model settings && initialization
#     print('using CNMR intensity', config.get('use_intensity', False))
#     gpt_config = CNMRSpectraConfig(n_layer=n_layer, n_head=n_head, n_embd=n_embd,
#                             dropout=dropout, bias=bias,
#                             prompt_pe=prompt_pe,
...
#                 model_args[k] = config[k]
#         # create the model
#         gptconf = CNMRSpectraConfig(**model_args)
#         model = CNMRSpectraGPT(gpt_config)
#         state_dict = checkpoint['model']
#         model.load_state_dict(state_dict, strict=False)
#     return model, model_args
...
#     # -----------------------------------------------------------------------------
#     # model settings && initialization
#     gpt_config = HSQCSpectraConfig(n_layer=n_layer, n_head=n_head, n_embd=n_embd,
#                             dropout=dropout, bias=bias,
#                             prompt_pe=prompt_pe,
#                             block_size=block_size,
#                             start_generate_token=start_generate_token
...
#                 model_args[k] = config[k]
#         # create the model
#         gptconf = HSQCSpectraConfig(**model_args)
#         model = HSQCSpectraGPT(gpt_config)
#         state_dict = checkpoint['model']
#         model.load_state_dict(state_dict, strict=False)
#     return model, model_args
...
def load_backward(output_dir:str,
                  agent_path:str,
                  config_path:str= 'config_[all_unfroz]_NoPromptPE_hnmr.yaml',
                  task:str='cnmr',
                  frozen_model:str=[],
                  device='cpu'):
