...
mol_related_dir = 'HNMR_Multi/all_unfroz_NPPE_hnmr'
spectra_related_dir = 'HNMR_Multi/all_unfroz_NPPE_hnmr'
os.makedirs(mol_related_dir, exist_ok=True)

config_path = 'config_[all_unfroz]_NoPromptPE_hnmr_Multi.yaml'
config = yaml.load(open(config_path, 'r'), Loader=yaml.FullLoader)



spectra_path = 'hnmr_config_multiset_large.yaml'
